...
\begin{exercice}
	...
	\begin{enumerate}
		\item n définit les courbes caractéristiques comme toutes les courbes paramétrées du plan $\R^2$ de coordonnées $(t, x)$ qui satisfont l'équation différentielle ordinaire :
		      \[
			      \frac{dx}{dt} = c(t, x).
		      \]
